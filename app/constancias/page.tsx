...
export default function ConstanciasPage() {
  const [solicitud, setSolicitud] = useState({
    ...
    salario: "$1200.00",
    estado: "Aprobada",
    fechaPeticion: "15 Agosto 2026",
  });

  const handleGenerar = () => {
    alert("Generando documento de constancia...");
  };
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="p-8 flex-1">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h1 className="text-2xl font-bold text-slate-800">Gestión de solicitudes</h1>
              <p className="text-xs text-slate-500 mt-1">Viernes 12 de Agosto de 2026</p>
            </div>
            <button
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pb-6 border-b border-slate-100">
              <h2 className="text-base font-bold text-slate-800">Información del empleado:</h2>
              <h2 className="text-base font-bold text-slate-800">Detalles de la petición:</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-6">
              <div className="space-y-4 text-sm">
                <div>
                  <p className="text-xs font-bold text-slate-800">Código de Empleado</p>
              ...
              <div className="space-y-4 text-sm">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-800">Dirigida a:</p>
                ...
                <div>
                  <p className="text-xs font-bold text-slate-800">Fecha de la petición</p>
                  <p className="text-slate-500 mt-0.5">{solicitud.fechaPeticion}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-end gap-4 pt-6 border-t border-slate-100 mt-4">
              <button
                ...
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold px-5 py-2.5 rounded-xl transition shadow-sm"
              >
                {/* Icono de Impresora */}
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6 9V2h12v7M6 18H4a2 2 0 01-2-2v-5a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-2m-16 0h16v4a1 1 0 01-1 1H5a1 1 0 01-1-1v-4z" />
                </svg>
                Generar Constancia
              </button>
              <button
